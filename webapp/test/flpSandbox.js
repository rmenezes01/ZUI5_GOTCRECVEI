		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#copersucarcomv2gotc01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"copersucarcomv2gotc01-display": {
								"semanticObject": "copersucarcomv2gotc01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=copersucar.com.v2.gotc01",
									"url": sap.ui.require.toUrl("copersucar/com/v2/gotc01")
								}
							}
						}
					}
